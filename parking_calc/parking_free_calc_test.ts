...
Deno.test("15 mins free", () => {
  startParkingAt("2020-01-01T00:00:00");
  endParkingAt("2020-01-01T00:14:59");
  calculate();
  shouldPay(0);
});
...
Deno.test("over 15 min not free", () => {
  startParkingAt("2020-01-01T00:00:00");
  endParkingAt("2020-01-01T00:15:00");
  calculate();
  shouldPay(30);
});
...
Deno.test("over 30 min then pay 60", () => {
  startParkingAt("2020-01-01T00:00:00");
  endParkingAt("2020-01-01T00:30:01");
  calculate();
  shouldPay(60);
});
...
Deno.test("over 60 min then pay 90", () => {
  startParkingAt("2020-01-01T00:00:00");
  endParkingAt("2020-01-01T01:00:00");
  calculate();
  shouldPay(90);
});
...
Deno.test("over 150 min then pay 150", () => {
  startParkingAt("2020-01-01T00:00:00");
  endParkingAt("2020-01-01T02:30:00");
  calculate();
  shouldPay(150);
});
